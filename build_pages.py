...
FONTS='<link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=UnifrakturCook:wght@700&family=Instrument+Sans:wght@400;500&display=swap" rel="stylesheet">'
...
<title>{title} | Trojan VPN</title><meta name="description" content="{desc}">
...
<header class="nav">
  ...
  <div class="nav__right"><a class="btn-play" href="pricing.html">Get Trojan</a>
...
<footer class="foot">
  ...
  <div class="foot__grid">
    <div class="foot__brand"><a class="logo" href="index.html#statue">Trojan VPN <small>MMXXVI</small></a>
      <p>Privacy built like an empire. Ancient discipline, modern encryption, and a promise carved in stone: we keep nothing.</p>
...
<div class="menu" id="menu" aria-hidden="true">
  ...
  <div class="menu__rule"></div><div class="menu__foot"><a class="btn-play" href="pricing.html">Get Trojan VPN</a></div>
</div>
...
pages['servers']=('Servers','The Trojan VPN network: 3,200 RAM-only servers across 94 cities and 41 nations.', 
 phero('Servers','A legion of servers,<br><em>stationed everywhere.</em>','Rome moved messages faster than any empire before it because it never let a courier tire. Our network hands your traffic along the fastest guarded road, and no station keeps a diary.','assets/gen-globe.jpg','III',[('Servers','3,200+'),('Cities','94'),('Nations','41')])+
 ...
 <section class="sec sec--alt"><div class="split">
  ...
  <p class="lead fx d2">Live figures from our nearest probe to you. Pick any city in the app and the legion routes you through it; pick none and we choose the fastest guarded road automatically.</p>
 ...
 <section class="sec"><div class="split split--rev">
  <figure class="fig fx"><img src="assets/gen-network.jpg" alt="Marble bust of Mercury"><figcaption>Fig. 01, The Messenger</figcaption></figure>
  ...
  <ul class="steps fx d2" style="margin-top:2rem">
   <li><div><h4>Boot from a signed image</h4><p>Every server boots a read-only image we sign in Zurich. If the checksum drifts by a byte, it refuses to join the legion.</p></div></li>
 ...
 <section class="band"><div class="bg" style="background-image:url('assets/gen-forum.jpg')"></div><blockquote class="quote fx"><p>"All roads lead to Rome. Ours just <em>refuse to remember</em> who walked them."</p><cite>From the Trojan engineering handbook</cite></blockquote></section>''','Servers')
...
pages['security']=('Security','How Trojan VPN protects you: AES-256, WireGuard, RAM-only servers, kill switch and the obfuscated Trojan protocol.',
 phero('Security','Walls that hold.<br><em>Secrets that stay.</em>','The Trojan horse worked because the walls of Troy were perfect and the gate was not. We built the gate first.','assets/gen-shield.jpg','IV',[('Cipher','AES-256'),('Protocol','WireGuard'),('Logs','None')])+
 ...
 <div class="grid3">
  ...
  <div class="tile fx d3"><span class="tile__num">IV</span><h3>Obfuscated Trojan protocol</h3><p>Our namesake. Traffic is wrapped to look like ordinary HTTPS so deep packet inspection sees nothing but browsing.</p></div>
 ...
 <section class="sec sec--alt"><div class="split">
  ...
  <p class="lead fx d2">Most VPNs are easy to spot on the wire, which is why restrictive networks block them. Trojan wraps WireGuard inside a TLS session that is indistinguishable from a visit to any ordinary website. The censor sees traffic to a web server. Inside, the legion moves.</p>
 ...
 <section class="sec"><div class="split split--rev">
  <figure class="fig fx"><img src="assets/gen-helmet.jpg" alt="Marble legionary helmet"><figcaption>Fig. 02, The Helmet</figcaption></figure>
...
pages['pricing']=('Pricing','Trojan VPN plans: Citizen, Senator and Emperor. 30 day money back guarantee.',
 phero('Pricing','Tribute worthy<br><em>of an empire.</em>','Three plans, one legion. Every plan gets every server, every protocol and the same no log promise. The difference is how many devices march with you.','assets/gen-laurel.jpg','V')+
 f'''<section class="sec">
 ...
 <div class="plans">
  ...
  <div class="plan plan--hero fx d1"><span class="plan__tag">Most chosen</span><h3>Senator</h3><div class="price">$<span data-m data-two="3.49" data-one="5.29" data-mo="11.99">3.49</span><small>/ month</small></div><div class="bill" data-m data-two="Billed $83.76 every 2 years" data-one="Billed $63.48 yearly" data-mo="Billed monthly">Billed $83.76 every 2 years</div>
   <ul><li>Everything in Citizen</li><li>10 devices at once</li><li>Obfuscated Trojan protocol</li><li>Multi-hop routes</li><li>Dedicated IP add on</li><li>Priority support</li></ul><a class="btn-outline" href="download.html">Choose Senator</a></div>
 ...
 <div class="fx" style="overflow:auto"><table class="cmp">
  ...
  <tr><td>Obfuscated Trojan protocol</td><td class="no">No</td><td class="ok">Yes</td><td class="ok">Yes</td></tr>
...
pages['download']=('Download','Download Trojan VPN for macOS, Windows, Android, iOS, Linux and routers.',
 phero('Download','Enter the gates<br><em>on every device.</em>','One account, every gate. Native apps for every platform you own, browser extensions, and router firmware for the whole household.','assets/gen-forum.jpg','VI',[('Platforms','6'),('Version','4.2'),('Size','38 MB')])+
 ...
 <section class="sec sec--alt"><div class="split">
  ...
  <ol class="steps fx d2" style="margin-top:2rem">
   ...
   <li><div><h4>Press connect</h4><p>We pick the fastest guarded road automatically. Choose a city if you prefer, or turn on the Trojan protocol if your network is restrictive.</p></div></li>
  </ol></div>
  <figure class="fig fx"><img src="assets/gen-scroll.jpg" alt="Sealed scroll on marble"><figcaption>Fig. 03, The Dispatch</figcaption></figure>
 </div></section>
 <section class="sec"><div class="split split--rev">
...
pages['about']=('About','Trojan VPN is a Swiss privacy company. Ancient discipline, modern encryption.',
 phero('About','We are the gate,<br><em>not the horse.</em>','Trojan was founded in 2021 by three engineers who kept getting asked the same question by friends abroad: which VPN can I actually trust? None of the answers held up. So we built one whose word could be checked.','assets/gen-forum.jpg','I',[('Founded','2021'),('Based','Zurich'),('People','46')])+
 f'''<section class="sec"><div class="split">
  ...
  <ul class="list fx d1">
   ...
   <li><span class="i">IV</span><span class="t">Stay small</span><span class="d">Forty six people. Enough to run a legion, few enough that everyone knows why.</span></li>
  </ul></div></section>
 ...
 <ul class="tl fx d1">
  ...
  <li><small>MMXXV</small><b>3,000 servers, 41 nations</b><p>The legion doubles. RAM-only becomes standard across the whole fleet.</p></li>
 ...
 <div class="cta-row fx d3"><a class="btn-solid" href="careers.html">Join the legion {ARROW}</a><a class="link-plain" href="contact.html">Contact us</a></div></section>''')

# ---------------- AUDITS ----------------
pages['audits']=('Audits','Independent security audits of Trojan VPN, published in full.',
 phero('Audits','Tested by people<br>paid to <em>break us.</em>','Every year we hire independent firms to attack our apps, servers and claims, then publish what they found without edits. Here is every report.','assets/gen-shield.jpg','IV',[('Audits','7'),('Open findings','0'),('Last','Jun 2026')])+
 ...
 <section class="band"><div class="bg" style="background-image:url('assets/gen-laurel.jpg')"></div><blockquote class="quote fx"><p>"A claim you cannot verify is <em>a rumour</em>. We publish so you never have to take our word."</p><cite>Tomas Brenner, head of security</cite></blockquote></section>''')

# ---------------- TRANSPARENCY ----------------
pages['transparency']=('Transparency report','Requests received by Trojan VPN and what we were able to provide: nothing.',
 phero('Transparency','What they asked.<br><em>What we had.</em>','Twice a year we publish every legal request received, from whom, and what we handed over. The last column has never changed.','assets/gen-scroll.jpg','II',[('Requests, H1 2026','23'),('Data provided','0'),('Servers seized','0')])+
...
pages['careers']=('Careers','Join Trojan VPN. Remote first, based in Zurich.',
 phero('Careers','Join the<br><em>legion.</em>','Forty six people across nine countries, remote first, paid in the top quartile, and asked to do one thing well: keep nothing.','assets/gen-helmet.jpg','VII',[('Open roles','5'),('Countries','9'),('Remote','Yes')])+
 ...
 <ul class="list">
  ...
  <li class="fx"><span class="i">04</span><span class="t">Support courier, India</span><span class="r">Remote, India</span><span class="d">Front line for our fastest growing region. Hindi, Telugu or Tamil plus English.</span></li>
  <li class="fx"><span class="i">05</span><span class="t">Brand designer</span><span class="r">Remote, Europe</span><span class="d">You saw the homepage. Make the rest of the empire look like that.</span></li>
 </ul></section>
 <section class="sec sec--alt"><div class="split">
  ...
  <div class="grid2 fx d1">
   ...
   <div class="tile"><h3>Four day weeks</h3><p>Thirty two hours. The legion rests so it can march.</p></div>
...
pages['contact']=('Contact','Contact Trojan VPN. Support, press, security disclosures.',
 phero('Contact','Send a<br><em>courier.</em>','Support answers around the clock. Press and security reports go to the people below. Nothing you send here is logged beyond the reply.','assets/gen-scroll.jpg','VIII')+
 f'''<section class="sec"><div class="split">
...
pages['privacy']=legal('privacy','Privacy policy','The short version: we do not collect what we do not need, and we need almost nothing.',[
 ...
 ('Changes','<p>Changes are announced 30 days ahead on this page and in the transparency report.</p>')],'assets/gen-scroll.jpg','LEX')
...
pages['terms']=legal('terms','Terms of service','Plain terms for a plain promise.',[
 ...
 ('Governing law','<p>Swiss law, courts of Zurich.</p>')],'assets/gen-forum.jpg','LEX')

pages['canary']=('Warrant canary','Trojan VPN warrant canary, renewed on the first of every month.',
 phero('Legal','The canary<br><em>still sings.</em>','On the first day of every month we sign a statement that we have received no secret orders. If this page ever goes stale, assume the worst.','assets/gen-laurel.jpg','IX',[('Renewed','1 Sep 2026'),('Next','1 Oct 2026'),('Status','Alive')])+
